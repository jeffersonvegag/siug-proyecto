...
<div class="section-body">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <h2 class="mb-4 card-header bg-dark py-6 card-label text-white fw-bolder fs-2">Formulario para editar el convenio específico</h2>
        <div class="card-body">


          <form id="form-editar" method="POST" enctype="multipart/form-data" action="?c=DocumentosGenerados&m=actualizarEspecifico&id=<?= urlencode($id_doc_gen) ?>">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="hidden" id="NOMBRE_PROYECTO_MAYUS" name="NOMBRE_PROYECTO_MAYUS">
        </div>
      </div>
    </div> -->
                    ...
                    <select id="SELECT_NOMBRE_PROYECTO" class="form-control">
                      ...
                      <?php foreach ($proyectos as $proyecto): ?>
                        <option
                          ...
                          <?= ($proyecto['IdProyecto'] == ($datos['IdProyecto'] ?? null)) ? 'selected' : '' ?>>
