<div class="section-body">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <h2 class="mb-4 card-header bg-dark py-6 card-label text-white fw-bolder fs-2">Formulario para completar el convenio marco</h2>
        <div class="card-body">


          <form method="POST" id="formMarco"  enctype="multipart/form-data" action="?c=convenio&m=generarDesdeFormularioMarco">
        ...
        <i class="fa fa-file-invoice me-2"></i>Generar documento
    </button>
...
<script>
document.addEventListener('DOMContentLoaded', function() {
    // Seleccionamos el formulario por su nuevo ID 'formMarco'
