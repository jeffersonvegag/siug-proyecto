<div class="section-body">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <h2 class="mb-4 card-header bg-dark py-6 card-label text-white fw-bolder fs-2">Formulario para completar el convenio adendum</h2>
        <div class="card-body">


          <form method="POST" id="formAdendum" enctype="multipart/form-data" action="?c=convenio&m=generarDesdeFormularioAdendum">
        ...
        <i class="fa fa-file-alt me-2"></i>Generar documento
    </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.getElementById('formAdendum');
